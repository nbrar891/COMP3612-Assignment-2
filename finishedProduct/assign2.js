...
//credit for sort: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort
    ...
    function sortTitle(songData){
        songData.sort((a, b) => {
            const songA = a.title.toString().toUpperCase();  
            const songB = b.title.toString().toUpperCase(); 
            if (songA < songB) {
              return -1;
            }
            if (songA > songB) {
    ...
    function sortArtist(songData){

        songData.sort((a, b) => {
            const songA = a.artist.name.toString().toUpperCase();  
            const songB = b.artist.name.toString().toUpperCase(); 
            if (songA < songB) {
              return -1;
            }
            if (songA > songB) {
    ...
    function sortYear(songData){
        songData.sort((a, b) => {
            const songA = a.year.toString().toUpperCase();  
            const songB = b.year.toString().toUpperCase(); 
            if (songA < songB) {
              return -1;
            }
            if (songA > songB) {
    ...
    function sortGenre(songData){
        songData.sort((a, b) => {
            const songA = a.genre.name.toString().toUpperCase();  
            const songB = b.genre.name.toString().toUpperCase(); 
            if (songA < songB) {
              return -1;
            }
            if (songA > songB) {
    ...
    function sortPopularity(songData){
        songData.sort((a, b) => {
            const songA = a.details.popularity.toString().toUpperCase();  
            const songB = b.details.popularity.toString().toUpperCase(); 
            if (songA < songB) {
              return -1;
            }
            if (songA > songB) {
...
titleNodeHeader.addEventListener("click", function(){
    ...
    for (let i = 0; i < songData.length; i++){
        ...
        newItem.textContent = songData[i].title
        newItem.dataset.id = songData[i].song_id
...
artistNodeHeader.addEventListener("click", function(){
    ...
    for (let i = 0; i < songData.length; i++){
        let newItem = document.createElement("li")
        newItem.textContent = songData[i].artist.name
...
yearNodeHeader.addEventListener("click", function(){
    ...
    for (let i = 0; i < songData.length; i++){
        let newItem = document.createElement("li")
        newItem.textContent = songData[i].year
...
genreNodeHeader.addEventListener("click", function(){
    ...
    for( let i = 0; i < songData.length; i++){
        let newItem = document.createElement("li")
        newItem.textContent = songData[i].genre.name
...
popularityNodeHeader.addEventListener("click", function(){
    ...
    sortPopularity(songData)
    for( let i = 0; i < songData.length; i++){
        let newItem = document.createElement("li")
        newItem.textContent = songData[i].details.popularity
